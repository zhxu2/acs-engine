...
{{end}}
    ...
    },
    {
      ...
      "properties": {
        ...
        "settings": {},
        "protectedSettings": {
          "commandToExecute": "[concat('/usr/bin/nohup /bin/bash -c \"/bin/bash /opt/azure/containers/provision.sh ',variables('clientPrivateKey'),' >> /var/log/azure/agent-provision.log 2>&1 &\" &')]"
        }
      }
    }
