...
var KubeConfigs = map[string]map[string]string{
	...
	common.KubernetesVersion1Dot8Dot6:       getK8sVersionComponents("1.8.6", map[string]string{"windowszip": "v1.8.6-2inthyperv.zip"}),
	common.KubernetesVersion1Dot8Dot4:       getK8sVersionComponents("1.8.4", nil),
	common.KubernetesVersion1Dot8Dot2:       getK8sVersionComponents("1.8.2", map[string]string{"windowszip": "v1.8.2-2inthyperv.zip"}),
	common.KubernetesVersion1Dot8Dot1:       getK8sVersionComponents("1.8.1", map[string]string{"windowszip": "v1.8.1-2inthyperv.zip"}),
	common.KubernetesVersion1Dot8Dot0:       getK8sVersionComponents("1.8.0", map[string]string{"windowszip": "v1.8.0-2inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot14:      getK8sVersionComponents("1.7.14", map[string]string{"windowszip": "v1.7.14-1inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot13:      getK8sVersionComponents("1.7.13", map[string]string{"windowszip": "v1.7.13-1inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot12:      getK8sVersionComponents("1.7.12", map[string]string{"windowszip": "v1.7.12-2inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot10:      getK8sVersionComponents("1.7.10", map[string]string{"windowszip": "v1.7.10-1inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot9:       getK8sVersionComponents("1.7.9", map[string]string{"windowszip": "v1.7.9-2inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot7:       getK8sVersionComponents("1.7.7", map[string]string{"windowszip": "v1.7.7-2inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot5:       getK8sVersionComponents("1.7.5", map[string]string{"windowszip": "v1.7.5-4inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot4:       getK8sVersionComponents("1.7.4", map[string]string{"windowszip": "v1.7.4-2inthyperv.zip"}),
	common.KubernetesVersion1Dot7Dot2:       getK8sVersionComponents("1.7.2", map[string]string{"windowszip": "v1.7.2-1inthyperv.zip"}),
...
func getK8sVersionComponents(version string, overrides map[string]string) map[string]string {
	...
	case "1.9":
		ret = map[string]string{
			"hyperkube":                   "hyperkube-amd64:v" + version,
			"ccm":                         "cloud-controller-manager-amd64:v" + version,
			"windowszip":                  "v" + version + "-1inthyperv.zip",
